 ...
 */
public class DayCalendarGridAdapter extends AbsBaseAdapter<String> {
    private String currentTime = RequestUtil.getCurrentTime();
    private String day = SharedUtil.getString(Constants.COURSE_CALENDAR_TODAY);
    private String clickday = SharedUtil.getString(Constants.COURSE_CALENDAR_CLICK);
    private TextView tv;
    private TextView saveClickTv;
    private LocalBroadcastManager localBroadcastManager;
    public DayCalendarGridAdapter(Context context) {
    ...
    public void bindView(ViewHolder viewHolder, final String data) {
        ...
        rv_calendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setAction("com.glory.broadcast.ChooseDate");
                ...
                if (day.equals(data)) { //是否点击的是今天
                    ...
                    SharedUtil.putString(Constants.COURSE_CALENDAR_CLICK, tag);
                    tv = tv_calendar;
                } else {
                    if(tv != null){
                        tv.setTextColor(context.getResources().getColor(R.color.primaryColor));
                ...
                intent1.setAction("com.glory.broadcast.CourseTableCalendar");
