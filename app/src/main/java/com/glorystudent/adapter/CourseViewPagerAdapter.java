...
import com.glorystudent.fragment.CourseCalendarFragment;
...
public class CourseViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        return CourseCalendarFragment.getInstance(getCurrentDay(subDay));
    }
    ...
    public List<String> getCurrentDay(int subDay){
