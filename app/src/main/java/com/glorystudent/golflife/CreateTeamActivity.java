...
import com.glorystudent.entity.ApplyTeamRequestEntity;
...
public class CreateTeamActivity extends BaseActivity {
    ...
    private ApplyTeamRequestEntity applyTeamRequestEntity;
    @Bind(R.id.back)
    ImageView back;
    @Bind(R.id.tv_submit)
    TextView submit;
    ...
    private void applyTeam() {
        ...
        String url = "/api/APITeam/CreateTeam";
...
//                    }
//                })
//                .setNegativeButton("继续创建", null).show();
//    }
